...
export class insertExamsClassificationsDetections1613701144949 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query('insert into examsDetectionsClassifications(id, name, description) values (\'580a2665-d0e8-4d36-81c2-c543eafa9671\', \'acúmulo natural da bexiga\', \'acúmulo esperado do radiotraçador\') on conflict(id) do nothing;');
	}
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query('delete from examsDetectionsClassifications where id=\'580a2665-d0e8-4d36-81c2-c543eafa9671\'');
	}
